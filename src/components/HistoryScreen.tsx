      ...
      <main className="flex-1 px-4 py-6">
        {history.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16">
            <History className={`w-16 h-16 mb-4 ${theme === "dark" ? "text-slate-700" : "text-slate-300"
              }`} />
            <p className={`text-center ${theme === "dark" ? "text-slate-500" : "text-slate-400"
              }`}>
              {t("history.noHistory")}
            </p>
          </div>
          ...
          <div className="space-y-3">
            {history.map((record) => (
              <div
                key={record.id}
                className={`backdrop-blur-sm border p-4 ${theme === "dark"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-2xl font-bold ${record.passed ? "text-emerald-500" : "text-red-500"
                          }`}>
                          {record.percentage}%
                        </span>
                      </div>
                    ...
                    {/* 所要時間 */}
                    <div className={`flex items-center gap-1 mt-2 text-sm ${theme === "dark" ? "text-slate-500" : "text-slate-400"
                      }`}>
