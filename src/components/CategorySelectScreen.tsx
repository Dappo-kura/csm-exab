  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === "dark"
      ...
      <main className="flex-1 px-4 py-6">
        ...
        <button
          onClick={toggleAll}
          className={`w-full mb-4 py-2 px-4 border rounded-lg text-sm font-medium transition-colors ${selectedCategories.length === categories.length
          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`w-full p-4 border rounded-lg flex items-center justify-between transition-all ${!hasQuestions
                  ? theme === "dark"
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-10 h-10 flex items-center justify-center rounded-lg ${categoryColors[category].bg
                      }`}
                  >
      ...
      <footer className={`sticky bottom-0 p-4 pb-8 pt-8 ${theme === "dark"
        ...
        {/* 選択中の問題数表示 */}
        <div className={`text-center mb-3 text-sm ${theme === "dark" ? "text-slate-400" : "text-slate-500"
          }`}>
          {language === "ja"
        ...
        <button
          ...
          className={`w-full py-4 px-6 font-bold text-lg rounded-full shadow-lg transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-3 ${selectedCategories.length === 0
